...
const files = [
  path.resolve(__dirname, "../../data/cefr/CEFR-SP_Wikiauto_train.txt"),
  path.resolve(__dirname, "../../data/cefr/CEFR-SP_Wikiauto_dev.txt"),
  path.resolve(__dirname, "../../data/cefr/CEFR-SP_Wikiauto_test.txt"),
];
